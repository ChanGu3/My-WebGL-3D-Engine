...
export var UniqueMatrix;
(function (UniqueMatrix) {
    UniqueMatrix[UniqueMatrix["Zero"] = 0] = "Zero";
    UniqueMatrix[UniqueMatrix["Identity"] = 1] = "Identity";
    UniqueMatrix[UniqueMatrix["RowMajor"] = 2] = "RowMajor";
    UniqueMatrix[UniqueMatrix["ColumnMajor"] = 3] = "ColumnMajor";
})(UniqueMatrix || (UniqueMatrix = {}));
/*
...
class Mat4 {
    ...
    **/
    ...
    inverse() {
        ...
        const det = this.data[0] * (this.data[5] * A2323 - this.data[6] * A1323 + this.data[7] * A1223) -
